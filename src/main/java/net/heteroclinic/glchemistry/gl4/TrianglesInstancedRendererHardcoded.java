...
public class TrianglesInstancedRendererHardcoded extends Renderer {
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			@Override
			public void run() {
				new BareBoneNewt(new TrianglesInstancedRendererHardcoded());
			}
		});
	}
	...
	public TrianglesInstancedRendererHardcoded() {
		//this.view = view;
		initTransform();
