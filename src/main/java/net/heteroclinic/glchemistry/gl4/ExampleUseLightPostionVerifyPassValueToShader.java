...
public class ExampleUseLightPostionVerifyPassValueToShader extends Renderer {

	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			@Override
			public void run() {
				new BareBoneNewt(new ExampleUseLightPostionVerifyPassValueToShader());
			}
		});
	}
	...
	protected final FloatBuffer lightPosition = FloatBuffer.allocate(4);
...
//        lightPosition.rewind();
	...
	public ExampleUseLightPostionVerifyPassValueToShader() {
		//this.view = view;
		initTransform();
	}
	...
	public void display(GLAutoDrawable drawable) {
        ...
        //light positioned at (0.f,0.f,1.f)
      lightPosition.clear();
      //lightPosition.put(new float[] {10.f,10.f,10.f});
      //lightPosition.put(new float[] {1.0f,0.0f,0.0f,1.0f});
      lightPosition.put(new float[] {0.0f,0.0f,1.0f,1.0f});
      lightPosition.rewind();
		gl.glUniform4fv(lightPositionLocation, 1, lightPosition);
...
//			}
	...
	protected static final String shaderBasename = "colorUseLightPosition";
