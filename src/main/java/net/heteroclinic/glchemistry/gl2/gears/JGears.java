package net.heteroclinic.glchemistry.gl2.gears;
...
public class JGears extends GLJPanel {
  ...
  public JGears() {
    ...
    try {
//      InputStream in = JGears.class.getClassLoader().getResourceAsStream("/home/zhikai/jogamp/jogl-demos/src/demos/data/images/java_logo.png");
//      BufferedImage image = ImageIO.read(in);
//      javaImage = scaleImage(image, 0.25f, 0.25f);
//
//      in = JGears.class.getClassLoader().getResourceAsStream("/home/zhikai/jogamp/jogl-demos/src/demos/data/images/java_logo.png");
